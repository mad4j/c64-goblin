...
115 REM CUSTOM CHARMAP, ORIGINAL CHARMAP, GAMEFIELD START ADDRESSES
...
141 REM DISABLE KEYB BUFFERING
142 POKE 649,1
...
550 GOSUB 2500
600 REM ### GAME LOOP
605 REM STORE ORIGINAL GOBLIN POSITION
610 TZ = Z
620 REM MOVE UP, WRAP BORDER IF NEEDED
630 IF P<3 THEN P=P+1 : GOTO 660
640 Z=Z-40 : IF Z<1144 THEN Z=Z+760
650 P=1
660 GET A$ 
670 IF A$="O" THEN Z=Z-1
680 IF A$="P" THEN Z=Z+1
690 REM CLEAR GOBLIN POSITION (IF NEEDED)
700 IF TZ<>Z THEN POKE TZ,SP
710 IF PEEK(Z)=BL THEN GOSUB 2300 : GOTO 400
720 IF PEEK(Z)=SF THEN GOSUB 2100
730 REM UPDATE GOBLIN POSITION (CHAR AND COL)
740 POKE Z,GB : POKE Z+GF,0
750 REM PAUSE
760 FOR T=1 TO 50 : NEXT T
770 IF W=36-G THEN GOSUB 2200 : GOTO 500
780 GOTO 600
900 REM ### GAME END 
...
9100 DATA 126,219,219,255,165,090,090,165
9200 DATA 060,066,165,129,153,165,066,060
9300 DATA 170,085,170,085,126,219,255,189
9400 DATA 060,066,165,129,165,153,066,060
9500 DATA 170,085,170,085,170,085,170,085