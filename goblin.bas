...
40 PRINT "{CLEAR}"
50 PRINT "{DOWN*5}{RIGHT*4}{GREEN}GOBLIN {RED}RELOADED"
60 PRINT "{DOWN*2}{RIGHT*4}{BLUE}DANIELE.OLMISANI@GMAIL.COM"
70 PRINT "{DOWN*2}{RIGHT*4}PLEASE WAIT... DEFINING CHARACTERS"
...
140 PRINT"{HOME}{RED}{DOWN*2}{SPACE*17}{REVERSE ON}HS="HS
145 PRINT"{HOME}{BLACK}{DOWN*22}{REVERSE ON}O=LEFT{REVERSE OFF}{SPACE*27}{REVERSE ON}P=RIGHT"
150 FOR I=1 TO 118
